      ...
      var runner = new Runner(src_folders, {
        ...
        fs.readFile(sampleReportFile, function(err, data) {
          ...
          try {
            ...
            //   errors="0" failures="1" hostname="" id="" package="FIREFOX_TEST_TEST_.sample" skipped="1"
            //   tests="2"
            assert.ok(content.match(/<testsuite[\s]+name="FIREFOX_TEST_TEST_.sample"[\s]+errors="0"[\s]+failures="1"[\s]+hostname=""[\s]+id=""[\s]+package="FIREFOX_TEST_TEST_.sample"[\s]+skipped="1"[\s]+tests="2"/g) !== null, 'Report does not contain correct testsuite information.')
